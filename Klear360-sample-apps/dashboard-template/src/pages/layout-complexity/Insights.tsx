...
import {
  ...
  Klear360Provider,
  ArrowUpRightIcon,
} from '@klearnow/klear360/components';
              ...
              <Box display="flex" alignItems="start" gap="spacing.5" height="100%">
                ...
                <Box display="flex" flexDirection="column">
                  ...
                  <Text
                    ...
                    color="surface.text.gray.muted"
                  >
                    Your success rates have dropped. Klearnow can help you find solutions to
                    increase it.
                  </Text>
                  <Box marginTop="spacing.4">
                    <Button variant="secondary" size="small">
                  ...
                  <Box display="flex" gap="spacing.5" marginTop="spacing.5">
                    <Box display="flex" alignItems="flex-start" gap="spacing.3">
                      ...
                      <Box display="flex" flexDirection="column" gap="spacing.2">
                        <Text size="medium">
                          Switching Netbanking to Billdesk and Klearnow will boost success by 1.2%.
                        </Text>
