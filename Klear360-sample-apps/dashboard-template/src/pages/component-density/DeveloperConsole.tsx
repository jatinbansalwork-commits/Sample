    ...
    >
      ...
      <Box display="flex" flexDirection="column" gap="spacing.8" padding="spacing.7">
        ...
        <Alert
          isFullWidth
          isDismissible={false}
          description="Key ID and Secret are shared across KlearnowX and Klearnow Payments dashboard"
          color="neutral"
          emphasis="subtle"
        />
      </Box>
...
const webhooks = [
  {
    id: '1',
    url: 'https://dashboard.klearnow.com/captcha?redirect=https%3...',
    status: 'Active',
    activeEvents: 1,
